...
# details. Here we fit the SARS-CoV-2 household  data collected in Vo'.        #                                                             #
#                                                                              #
# Cite as:                                                                     #
...
# source scripts
source("R/functions_fit_2_groups_model.R")
...
#
# # load sources
# list_sources <- c("R/functions_fit_2_groups_model.R",
...
parameters <- read.csv("data/household_model/Default_parameters_2_groups.csv",
                       header = TRUE)

# read model variants
par <- read.csv("data/household_model/Model_variants_2_groups.csv", header = TRUE)

# read MCMC parameters
mcmc_par <- read.csv("data/household_model/MCMC_parameters_2_groups.csv", header = TRUE)

# Create output folders -------------------------------------------------------#
dir_output  <- file.path("mcmc_posterior_chains_2_groups")
...
file_res <- "mcmc_posterior_estimates_2_groups.csv"
