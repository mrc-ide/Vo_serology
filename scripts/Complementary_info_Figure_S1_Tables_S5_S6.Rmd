...
May_survey[,4] = factor(May_survey[,4], levels = levels(May_survey[,4]),
                      labels=paste(c(1, 10, 1280, 160, 20, 320, 40, 640, 80, 0)))
...
with(May_survey, 
     { plot(Neutralization~Diasorin, cex=0.5) ; abline(lm(Neutralization~Diasorin)) ;
       #lines(lowess(Neutralization~Diasorin), col="red") 
...
with(May_survey, 
     { N.res = resid(lm(Neutralization~Abbott+Roche)) ;
       ...
       #lines(lowess(N.res~D.res), col="red") 
#       corr = cor.test(N.res, D.res)
...
with(May_survey, 
     { N.res = resid(lm(Neutralization~Diasorin+Roche)) ;
       ...
       #lines(lowess(N.res~A.res), col="red") 
#       corr = cor.test(N.res, A.res)
...
with(May_survey, 
     { D.res = resid(lm(Diasorin~Neutralization+Roche)) ;
       ...
       #lines(lowess(D.res~A.res), col="red") 
#       corr = cor.test(D.res, A.res)
...
with(May_survey, 
     { plot(Abbott~Roche, cex=0.5) ; abline(lm(Abbott~Roche)) ;
       #lines(lowess(Abbott~Roche), col="red") 
...
with(May_survey, 
     { N.res = resid(lm(Neutralization~Diasorin+Abbott)) ;
       ...
       #lines(lowess(N.res~R.res), col="red") 
#       corr = cor.test(N.res, R.res)
...
with(May_survey, 
     { D.res = resid(lm(Diasorin~Neutralization+Abbott)) ;
       ...
       #lines(lowess(D.res~R.res), col="red") 
#       corr = cor.test(D.res, R.res)
...
with(May_survey, 
     { A.res = resid(lm(Abbott~Neutralization+Diasorin)) ;
       ...
       #lines(lowess(A.res~R.res), col="red") 
#       corr = cor.test(A.res, R.res)
...
Nov_survey[,4] = factor(Nov_survey[,4], levels = levels(Nov_survey[,4]),
                      labels=paste(c(1, 640, 10, 1280, 160, 20, 320, 40, 80, 0)))
...
Table S1
========
*Assay-specific performance against the different ground truth definitions.*

Data used: May serosurvey

<!-- 
**Extract dataset**
```{r}
May_siero = data.frame(Vo_serology_data[,c(270,272,274,302:304)])
tmp = May_siero[,4:6]
tmp[tmp == 1] = "Positive"
tmp[is.na(tmp)] = "Negative"
May_siero[,4:6] = tmp
May_siero[May_siero=="NA"] = NA

# ???
May_siero[May_siero=="Dubious"] = "Negative"

May_siero = May_siero[!apply(May_siero, 1, function(x) any(is.na(x))),]
```
...
```{r}
round(prop.table(table(May_siero[,c(1,4)]), 2), 4)*100
prop.test(table(May_siero[,c(1,4)])[-1,][1,1], margin.table(table(May_siero[,c(1,4)])[-1,], 2)[1])
prop.test(table(May_siero[,c(1,4)])[-1,][2,2], margin.table(table(May_siero[,c(1,4)])[-1,], 2)[2])
```

*Abbott*

```{r}
round(prop.table(table(May_siero[,c(2,4)]), 2), 4)*100
prop.test(table(May_siero[,c(2,4)])[1,1], margin.table(table(May_siero[,c(2,4)]), 2)[1])
prop.test(table(May_siero[,c(2,4)])[2,2], margin.table(table(May_siero[,c(2,4)]), 2)[2])
```

*Roche*

```{r}
round(prop.table(table(May_siero[,c(3,4)]), 2), 4)*100
prop.test(table(May_siero[,c(3,4)])[1,1], margin.table(table(May_siero[,c(3,4)]), 2)[1])
prop.test(table(May_siero[,c(3,4)])[2,2], margin.table(table(May_siero[,c(3,4)]), 2)[2])
```
...
```{r}
round(prop.table(table(May_siero[,c(1,4)]), 1), 4)*100
prop.test(table(May_siero[,c(1,4)])[-1,][1,1], margin.table(table(May_siero[,c(1,4)])[-1,], 1)[1])
prop.test(table(May_siero[,c(1,4)])[-1,][2,2], margin.table(table(May_siero[,c(1,4)])[-1,], 1)[2])
```

*Abbott*

```{r}
round(prop.table(table(May_siero[,c(2,4)]), 1), 4)*100
prop.test(table(May_siero[,c(2,4)])[1,1], margin.table(table(May_siero[,c(2,4)]), 1)[1])
prop.test(table(May_siero[,c(2,4)])[2,2], margin.table(table(May_siero[,c(2,4)]), 1)[2])
```

*Roche*

```{r}
round(prop.table(table(May_siero[,c(3,4)]), 1), 4)*100
prop.test(table(May_siero[,c(3,4)])[1,1], margin.table(table(May_siero[,c(3,4)]), 1)[1])
prop.test(table(May_siero[,c(3,4)])[2,2], margin.table(table(May_siero[,c(3,4)]), 1)[2])
```
...
```{r}
round(prop.table(table(May_siero[,c(1,5)]), 2), 4)*100
prop.test(table(May_siero[,c(1,5)])[-1,][1,1], margin.table(table(May_siero[,c(1,5)])[-1,], 2)[1])
prop.test(table(May_siero[,c(1,5)])[-1,][2,2], margin.table(table(May_siero[,c(1,5)])[-1,], 2)[2])
```

*Abbott*

```{r}
round(prop.table(table(May_siero[,c(2,5)]), 2), 4)*100
prop.test(table(May_siero[,c(2,5)])[1,1], margin.table(table(May_siero[,c(2,5)]), 2)[1])
prop.test(table(May_siero[,c(2,5)])[2,2], margin.table(table(May_siero[,c(2,5)]), 2)[2])
```

*Roche*

```{r}
round(prop.table(table(May_siero[,c(3,5)]), 2), 4)*100
prop.test(table(May_siero[,c(3,5)])[1,1], margin.table(table(May_siero[,c(3,5)]), 2)[1])
prop.test(table(May_siero[,c(3,5)])[2,2], margin.table(table(May_siero[,c(3,5)]), 2)[2])
```
...
```{r}
round(prop.table(table(May_siero[,c(1,5)]), 1), 4)*100
prop.test(table(May_siero[,c(1,5)])[-1,][1,1], margin.table(table(May_siero[,c(1,5)])[-1,], 1)[1])
prop.test(table(May_siero[,c(1,5)])[-1,][2,2], margin.table(table(May_siero[,c(1,5)])[-1,], 1)[2])
```

*Abbott*

```{r}
round(prop.table(table(May_siero[,c(2,5)]), 1), 4)*100
prop.test(table(May_siero[,c(2,5)])[1,1], margin.table(table(May_siero[,c(2,5)]), 1)[1])
prop.test(table(May_siero[,c(2,5)])[2,2], margin.table(table(May_siero[,c(2,5)]), 1)[2])
```

*Roche*

```{r}
round(prop.table(table(May_siero[,c(3,5)]), 1), 4)*100
prop.test(table(May_siero[,c(3,5)])[1,1], margin.table(table(May_siero[,c(3,5)]), 1)[1])
prop.test(table(May_siero[,c(3,5)])[2,2], margin.table(table(May_siero[,c(3,5)]), 1)[2])
```
...
```{r}
round(prop.table(table(May_siero[,c(1,6)]), 2), 4)*100
prop.test(table(May_siero[,c(1,6)])[-1,][1,1], margin.table(table(May_siero[,c(1,6)])[-1,], 2)[1])
prop.test(table(May_siero[,c(1,6)])[-1,][2,2], margin.table(table(May_siero[,c(1,6)])[-1,], 2)[2])
```

*Abbott*

```{r}
round(prop.table(table(May_siero[,c(2,6)]), 2), 4)*100
prop.test(table(May_siero[,c(2,6)])[1,1], margin.table(table(May_siero[,c(2,6)]), 2)[1])
prop.test(table(May_siero[,c(2,6)])[2,2], margin.table(table(May_siero[,c(2,6)]), 2)[2])
```

*Roche*

```{r}
round(prop.table(table(May_siero[,c(3,6)]), 2), 4)*100
prop.test(table(May_siero[,c(3,6)])[1,1], margin.table(table(May_siero[,c(3,6)]), 2)[1])
prop.test(table(May_siero[,c(3,6)])[2,2], margin.table(table(May_siero[,c(3,6)]), 2)[2])
```
...
```{r}
round(prop.table(table(May_siero[,c(1,6)]), 1), 4)*100
prop.test(table(May_siero[,c(1,6)])[-1,][1,1], margin.table(table(May_siero[,c(1,6)])[-1,], 1)[1])
prop.test(table(May_siero[,c(1,6)])[-1,][2,2], margin.table(table(May_siero[,c(1,6)])[-1,], 1)[2])
```

*Abbott*

```{r}
round(prop.table(table(May_siero[,c(2,6)]), 1), 4)*100
prop.test(table(May_siero[,c(2,6)])[1,1], margin.table(table(May_siero[,c(2,6)]), 1)[1])
prop.test(table(May_siero[,c(2,6)])[2,2], margin.table(table(May_siero[,c(2,6)]), 1)[2])
```

*Roche*

```{r}
round(prop.table(table(May_siero[,c(3,6)]), 1), 4)*100
prop.test(table(May_siero[,c(3,6)])[1,1], margin.table(table(May_siero[,c(3,6)]), 1)[1])
prop.test(table(May_siero[,c(3,6)])[2,2], margin.table(table(May_siero[,c(3,6)]), 1)[2])
```
-->
